...
class Board {
    constructor() {
        ...
        this._leftPageUp.addEventListener("click", () => {
        ...
        this._leftPageDown.addEventListener("click", () => {
            this._leftPageButtonsOffset++;
            this.updateLeftPageLayout();
        });
    ...
    addButtonLeftPage(value, onClickCallback, imgPath = "") {
